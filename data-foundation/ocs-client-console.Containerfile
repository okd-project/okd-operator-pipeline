...
COPY --from=builder /opt/app-root/src/plugins/client/dist .
...
LABEL description="OKD Container Storage Client Console container" \
    summary="Provides the latest client console for OKD Container Storage." \
    io.k8s.display-name="OCS Client Console"
