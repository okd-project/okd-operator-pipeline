...
COPY Containerfile.ocp.cached Containerfile.ocp.cached
RUN /dockerfile-drifter.sh Containerfile.ocp Containerfile.ocp.cached
...
COPY --from=ui-build $REMOTE_SOURCES_DIR/flightctl-ui/app/apps/ocp-plugin/dist /app/proxy/dist
...
LABEL com.redhat.component="acm-flightctl-ocp-ui-container" \
      name="rhacm2/acm-flightctl-ocp-ui-rhel9" \
      version="v2.13.3" \
      upstream-ref="0c56e00e3798c89742dce8744de79ecfe60d8f6f" \
      upstream-url="git@github.com:flightctl/flightctl-ui.git" \
      summary="acm-flightctl-ocp-ui" \
