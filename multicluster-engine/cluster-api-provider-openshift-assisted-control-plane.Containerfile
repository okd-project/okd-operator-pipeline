...
ENV COMPONENT_NAME=cluster-api-provider-openshift-assisted-control-plane
...
# Copy the go source
COPY --chown=default cluster-api-provider-openshift-assisted/controlplane/main.go controlplane/main.go
...
COPY --chown=default cluster-api-provider-openshift-assisted/controlplane/internal/ controlplane/internal/
